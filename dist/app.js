...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      header: "Welcome to Car Buyer Pro",
      bkg: chrome.extension.getBackgroundPage()
    };
  },
  mounted: function mounted() {
    var vm = this;
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://my-json-server.typicode.com/typicode/demo/posts").then(function (data) {
      vm.bkg.console.log(data);
    });
  }
});
...
module.exports = __webpack_require__(/*! /Users/nathanback/code/extensions/car-buyer-pro/src/app.js */"./src/app.js");
